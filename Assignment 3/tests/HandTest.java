...
public class HandTest {
	...
	*/
	...
	void test_addGetNumericalValue_2() {
		...
		assertTrue(values.get(1) == 22);
		
		assertTrue(values.get(2) == 12);
		...
		assertTrue(values.get(0) == 44);
		assertTrue(values.get(1) == 34);
		assertTrue(values.get(2) == 24);
		assertTrue(values.get(3) == 14);
		assertTrue(values.get(4) == 4);
	}
}
